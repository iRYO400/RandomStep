 ...
 */
public class RecyclerViewFragmentCrafts extends Fragment {
    ...
    public static RecyclerViewFragmentCrafts newInstance() {
        return new RecyclerViewFragmentCrafts();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        array_image.add(R.drawable.craft1);
        array_image.add(R.drawable.craft2);
        array_image.add(R.drawable.craft3);
        array_image.add(R.drawable.craft4);

        mGenresContent = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.Crafts)));
