 ...
 */
public class RecyclerViewFragmentWorld extends Fragment {
    ...
    public static RecyclerViewFragmentWorld newInstance() {
        return new RecyclerViewFragmentWorld();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        array_image.add(R.drawable.world1);
        array_image.add(R.drawable.world2);
        array_image.add(R.drawable.world3);
        array_image.add(R.drawable.world4);
        array_image.add(R.drawable.world5);

        mGenresContent = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.World)));
