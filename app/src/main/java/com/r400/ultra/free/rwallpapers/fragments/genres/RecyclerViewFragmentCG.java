 ...
 */
public class RecyclerViewFragmentCG extends Fragment {
    ...
    public static RecyclerViewFragmentCG newInstance() {
        return new RecyclerViewFragmentCG();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        array_image.add(R.drawable.cg1);
        array_image.add(R.drawable.cg2);
        array_image.add(R.drawable.cg3);
        array_image.add(R.drawable.cg4);

        mGenresContent = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.CG_Art)));
